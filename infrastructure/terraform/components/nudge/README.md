...
| <a name="input_core_environment"></a> [core\_environment](#input\_core\_environment) | The source environment in core that sends the unnotified messages to the nudge component | `string` | `"internal-dev"` | no |
